...
import { icArrowUp, icGrid, icLogOut, icPlus, icUserActive, icPencilSmall, icArrowLeft, icX ,icUser} from '../../assets';
                  ...
                  <div className="col-12 text-center ">
                    ...
                    { this.props.userData.photo === '-' ? 
                        (
                            ...
                            <img alt="" src={process.env.REACT_APP_URL+'images/'+this.props.userData.photo} className="img-fluid profile-image" />
                        )
                      ...
                      <div className="mt-4 text-center position-relative">
                        ...
                        { this.props.userData.photo === '-'  ?
                          (
                            ...
                            <img className="avatar" src={process.env.REACT_APP_URL+'images/'+this.props.userData.photo} alt="" />
                          )
